		...
		<Grid container spacing={3} sx={{ mb: 4 }}>
			<Grid item size={{ xs: 12, md: 3 }}>
				<StatusCard 
					...
					bgColor={green[50]}
					fgColor={green[500]}
					icon={<CheckCircleOutlined fontSize='medium' color={green[500]} />}
				/>
			</Grid>
			<Grid item size={{ xs: 12, md: 3 }}>
				<StatusCard
					...
					bgColor={blue[50]}
					fgColor={blue[500]}
					icon={<SyncOutlined fontSize='medium' color={blue[500]} />}
			...
			<Grid item size={{ xs: 12, md: 3 }}>
				<StatusCard
					...
					bgColor={orange[50]}
					fgColor={orange[500]}
					icon={<PauseCircleOutlineOutlined fontSize='medium' color={orange[500]} />}
				/>
			</Grid>
			<Grid item size={{ xs: 12, md: 3 }}>
				<StatusCard
					...
					bgColor={red[50]}
					fgColor={red[500]}
					icon={<ErrorOutlineOutlined fontSize='medium' color={red[500]} />}
				/>
			</Grid>
		</Grid>
	)
