                ...
                <Grid size={{ xs: 12 }}>
                    <Box sx={{ mb: 1 }}>
                        ...
                        <p style={{ margin: 0, color: grey[700], lineHeight: 1.6 }}>
                            Workflows are series of calculations that perform common tasks,
                            packaged into a simply called directive. Select a workflow below to see
                            what it does, then continue into the submission page to set up
                            your job.
                        </p>
                    </Box>
                </Grid>
                                ...
                                {workflow.enabled && (
                                    <Collapse in={isExpanded} timeout="auto" unmountOnExit>
                                        <Box sx={{ mt: 2, pt: 2, borderTop: '1px solid', borderColor: 'divider' }}>
                                            <p style={{ margin: 0, color: grey[700], lineHeight: 1.6, fontSize: '0.9rem' }}>
