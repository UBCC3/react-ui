...
import { AdjustOutlined, CalculateOutlined, DataObjectOutlined } from "@mui/icons-material";
				...
				>
					...
					>
						...
						>
							...
							<FormControlLabel
								control={
									<Checkbox checked={vectorOn} onChange={(e) => setVectorOn(e.target.checked)} />
								}
								label="Vector ON"
							/>
						</Grid>
