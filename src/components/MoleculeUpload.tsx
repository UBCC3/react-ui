 ...
 */
const MoleculeUpload: React.FC<MoleculeUploadProps> = ({ open, setOpen, setLibraryStructures }) => {
	...
	return (
		<React.Fragment key={anchor}>
			...
			>
				...
				<Box
					p={3}
					className="bg-stone-100 h-full display flex flex-col"
					gap={3}
					component="form"
				...
				>
					...
					>
						...
						<input hidden type="file" accept=".xyz" onChange={handleFileChange} />
					</Button>
					<MolmakerTextField
						fullWidth
						label="Name"
					...
					<MolmakerTextField
						...
						helperText={
							submitAttempted && chemicalFormula === "" ? "Chemical formula is required" : ""
						}
						required
					/>
					<MolmakerTextField
